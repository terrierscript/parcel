...
class Bundler extends EventEmitter {
  ...
  bundle() {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        ...
        try {
          for (
            var _iterator4 = changedAssets[Symbol.iterator](), _step4;
  ...
  loadAsset(asset) {
    ...
    return _asyncToGenerator(function*() {
      ...
      if (_this11.delegate.getImplicitDependencies) {
        let implicitDeps = yield _this11.delegate.getImplicitDependencies(
          asset
        );
        if (implicitDeps) {
  ...
  createBundleTree(asset, bundle, dep, parentBundles = new Set()) {
    ...
    try {
      for (
        var _iterator5 = asset.depAssets[Symbol.iterator](), _step5;
  ...
  moveAssetToBundle(asset, commonBundle) {
    ...
    try {
      for (
        var _iterator6 = Array.from(asset.bundles)[Symbol.iterator](), _step6;
    ...
    try {
      for (
        var _iterator7 = asset.depAssets.values()[Symbol.iterator](), _step7;
  ...
  *findOrphanAssets() {
    ...
    try {
      for (
        var _iterator8 = this.loadedAssets.values()[Symbol.iterator](), _step8;
  ...
  unloadOrphanedAssets() {
    ...
    try {
      for (
        var _iterator9 = this.findOrphanAssets()[Symbol.iterator](), _step9;
  ...
  unloadAsset(asset) {
    ...
    if (this.watcher) {
      ...
      try {
        for (
          var _iterator10 = asset.dependencies.values()[Symbol.iterator](),
            _step10;
  ...
  onChange(path) {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        for (
          var _iterator11 = assets[Symbol.iterator](), _step11;
      ...
      _this12.rebuildTimeout = setTimeout(
