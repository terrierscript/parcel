  ...
  loadRelative(filename, extensions) {
    ...
    return _asyncToGenerator(function*() {
      ...
      return (
        ...
        (yield _this3.loadDirectory(filename, extensions, pkg))
      );
    })();
  }
  ...
  loadDirectory(dir, extensions, pkg) {
    ...
    return _asyncToGenerator(function*() {
      try {
        ...
        let res =
          (yield _this6.loadAsFile(main, extensions, pkg)) ||
          (yield _this6.loadDirectory(main, extensions, pkg));
