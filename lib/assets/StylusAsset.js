...
let getDependencies = (() => {
  var _ref = _asyncToGenerator(function*(
    ...
    var _ref2 = yield Promise.all(
        ['parser', 'visitor/deps-resolver', 'nodes', 'utils'].map(function(
          dep
        ) {
      ...
      Array.from(deps.entries()).map(
        (() => {
          var _ref4 = _asyncToGenerator(function*([path, resolved]) {
            ...
            try {
              for (
                var _iterator = found[Symbol.iterator](), _step;
                ...
                if (!seen.has(resolved)) {
                  ...
                  try {
                    for (
                      var _iterator2 = (yield getDependencies(
                          code,
                          resolved,
                          asset,
                          options,
