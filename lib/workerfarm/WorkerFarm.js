...
class WorkerFarm extends EventEmitter {
  ...
  onExit(childId) {
    ...
    setTimeout(() => {
      ...
      if (child && child.calls.size) {
        ...
        try {
          for (
            var _iterator = child.calls.values()[Symbol.iterator](), _step;
  ...
  processQueue() {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        for (
          var _iterator2 = _this.children.values()[Symbol.iterator](), _step2;
  ...
  addCall(method, args) {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        for (
          var _iterator3 = _this2.children.keys()[Symbol.iterator](), _step3;
  ...
  initRemoteWorkers(options) {
    ...
    return _asyncToGenerator(function*() {
      ...
      for (
        let i = _this3.children.size;
        i < _this3.options.maxConcurrentWorkers;
        i++
      ) {
        _this3.startChild();
      }
      ...
      try {
        for (
          var _iterator4 = _this3.children.values()[Symbol.iterator](), _step4;
